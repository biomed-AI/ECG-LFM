...
if TYPE_CHECKING:
    from fairseq_signals.modules.multihead_attention import MultiheadAttention
...
class FileContentsAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        from fairseq_signals.file_io import PathManager
...
def load_ensemble_for_inference(filenames, task, model_arg_overrides=None):
    from fairseq_signals import checkpoint_utils
...
def replace_unk(hypo_str, src_str, alignment, align_dict, unk):
    from fairseq_signals import tokenizer
...
def get_activation_fn(activation: str) -> Callable:
    ...
    from fairseq_signals.modules import gelu, gelu_accurate
...
def tpu_data_loader(itr):
    ...
    from fairseq_signals.data import iterators
